<template>
  <div class="ui grid dashboard" v-if="coin">
    <div class="sixteen wide column">
      ...
      <p class="dashboard__trading">
        Currently trading at
        <span class="segment__primary"> ${{ coinQuotes.price }}</span>
      </p>
      <p class="dashboard__market-cap">
        with a Market Cap of
        <span class="segment__primary">{{
      ...
      <div class="ui cards">
        <div class="card">
          <div class="content">
            ...
            <div class="meta">
              Volume that has been traded in the last 24hrs
            </div>
        ...
        <div class="card">
          <div class="content">
            ...
            <div
              class="description"
              :class="[
                isValuePositive(coinQuotes.percent_change_7d)
                  ? 'segment__positive'
                  : 'segment__negative'
              ]"
            >
...
<script>
import { formatCurrency, isValuePositive } from '@/utils'
...
<style src="@/assets/styles/coin-details-page.css"></style>
